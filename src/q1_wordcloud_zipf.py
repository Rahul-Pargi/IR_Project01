...
# === LOAD DATA (correct lowercase filename inside data/) ===
data_dir = os.path.join(os.path.dirname(__file__), "..", "data")
posts_path = os.path.join(data_dir, "posts.xml")  # lowercase filename
...
plt.title(f'Zipf plot (log-log). Slope ~= {slope:.3f}, R^2 = {r2:.3f}')
plt.grid(True)
plt.show()
