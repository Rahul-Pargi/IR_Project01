...
## 📌 Project Overview
This project focuses on building and evaluating an **Information Retrieval (IR) System** using data from the **Gaming StackExchange**. The system processes, indexes, and retrieves relevant questions and answers to simulate real-world information-seeking scenarios.  
